...
const Cart = ({ cart, setCart }) => {
    ...
    return (
        <div className="max-w-300 mx-auto p-6 border border-gray-100 rounded-2xl bg-white shadow-sm mt-10">
            <h2 className="text-xl font-bold mb-6 text-slate-900">Your Cart</h2>
